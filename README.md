...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lxml-stubs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12735&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lxml-stubs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lxml-stubs` can be installed with:

```
conda install lxml-stubs
```

It is possible to list all of the versions of `lxml-stubs` available on your platform with:
